...
import escudo from '@public/images/escudo.png'
...
function Login () {
  ...
  return (
    <main className='flex flex-col gap-8 justify-center items-center h-screen'>
      ...
      <form onSubmit={handleSubmit} className='bg-secondary m-2 flex flex-col gap-4 w-80 p-6 shadow-lg rounded-2xl'>
        ...
        <Button
          className='bg-udenar-primary font-semibold'
          type='submit'
          isLoading={isLoading}
